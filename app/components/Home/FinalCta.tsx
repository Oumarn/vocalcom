            ...
            <section className="py-16 relative overflow-hidden bg-white">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center animate-fade-up">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        <a href="#demo" className="inline-flex items-center justify-center gap-2 px-4 sm:px-8 py-2 sm:py-4 text-xs sm:text-sm text-white font-bold rounded-full hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1" style={{background: 'linear-gradient(90deg, #F6A02E, #f97316)'}}>
                            {content.button}
