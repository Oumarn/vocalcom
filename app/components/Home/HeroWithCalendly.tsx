...
import CalendlyWidget from '../forms/CalendlyWidget';
import type { landingFR } from '@/content/landing.fr';

export default function HeroWithCalendly({ content, calendlyUrl }: { content: typeof landingFR.hero, calendlyUrl: string }) {
