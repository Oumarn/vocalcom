...
export default function AppFooterEs({ content }: { content: typeof landingFR.footer }) {
    return (
        <>
            <footer className="bg-gradient-to-br from-slate-50 via-white to-slate-50 py-12 lg:py-16 border-t border-slate-200">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                        ...
                        {/* Phone numbers */}
                        <div>
                            <h3 className="text-sm font-bold mb-4 text-slate-900 uppercase tracking-wider">
                                Contact
                            </h3>

                            <ul className="space-y-3">
                                <li>
                                    <Link href="tel:+34915646400" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        España, Madrid : +34 915 64 64 00
                                    </Link>
                                </li>

                                <li>
                                    <Link href="tel:+34935565200" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        España, Barcelone : +34 93 556 52 00
                                    </Link>
                                </li>

                                <li>
                                    <Link href="tel:+541152749200" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        Argentina : +54 11 52 74 92 00
                                    </Link>
                                </li>

                                <li>
                                    <Link href="tel:+56967951716" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        Chile : +56 9 67951716
                                    </Link>
                                </li>

                                <li>
                                    <Link href="tel:+573144155261" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        Colombia : +57 314 415 5261
                                    </Link>
                                </li>

                                <li>
                                    <Link href="tel:+5590633858" className="text-sm text-slate-600 hover:text-violet-600 hover:translate-x-1 inline-block transition-all duration-200">
                                        México : +55 906 33858
                                    </Link>
                                </li>
                            </ul>
